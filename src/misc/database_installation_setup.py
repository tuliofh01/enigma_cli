...
'''
This script must be triggered during the misc process
(from the controllers folder).
Basically, it will create a data in case it doesn't exist.
Otherwise, it will add users to the data.
'''
